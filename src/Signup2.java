...
public class Signup2 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
        ...
        if(r1.isSelected()) {
        	h = "YES";
//        	boolean r212=r2.isSelected();
//        	r212=false;
        	r2.setSelected(false);
        }
        else if(r2.isSelected()) {
        	h = "NO";
//        	boolean r122=r1.isSelected();
//        	r122=false;
//        	r122.add();
        	r1.setSelected(false);
        }
        String i = "";int counter = 0;
        if(r3.isSelected() && counter ==0){ 
            i = "YES";
            counter++;
        }else if(r4.isSelected() && counter ==0){ 
            i = "NO";
            counter++;
        }
	...
	public static void main(String[] args) {
		Signup2 sng2 = new Signup2();
		sng2.setVisible(true);
